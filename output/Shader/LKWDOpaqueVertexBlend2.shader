Shader "LKWD/Opaque/VertexBlend2" {
	Properties {
		_MainTex ("Texture 1 (Black)", 2D) = "white" {}
		...
		Pass {
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					{
					  lowp vec4 tmpvar_1;
					  tmpvar_1 = mix (texture2D (_MainTex, xlv_TEXCOORD0), texture2D (_Texture2, xlv_TEXCOORD1), xlv_TEXCOORD2.xxxx);
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  lowp vec4 final_1;
					  lowp vec4 tmpvar_2;
					  tmpvar_2 = mix (texture2D (_MainTex, xlv_TEXCOORD0), texture2D (_Texture2, xlv_TEXCOORD1), xlv_TEXCOORD2.xxxx);
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  lowp vec4 final_2;
					  lowp vec4 tmpvar_3;
					  tmpvar_3 = mix (texture2D (_MainTex, xlv_TEXCOORD0), texture2D (_Texture2, xlv_TEXCOORD1), xlv_TEXCOORD2.xxxx);
